...
CHECK_USER_URL = "https://your-api.com/check-user"  # Foydalanuvchini tekshirish uchun API URL
REGISTER_USER_URL = "https://your-api.com/register-user"  # Foydalanuvchini ro'yxatdan o'tkazish uchun API URL
